...
{
    public static string CreateEnumerableClass<T>(IEnumerable<T> objs, Func<T, string> idSelector, DumpOptions? options = null)
    {
    ...
    public static string CreateClass<T>(T obj, DumpOptions? options = null)
    {
        options ??= DumpOptionsFactory.Create();
        ...
        var generatorAssemblyName = typeof(CSharpDumper).Assembly.GetName();
    ...
    private static string ProcessObject<T>(T obj, Func<T, string> idSelector, List<string> ids, DumpOptions? options)
    {
    ...
    private static StringBuilder CreateClass(List<string> namespaces, string friendlyName, Type type, StringBuilder yieldBuilder, StringBuilder membersBuilder)
    {
        ...
        var preamble =
              ...
              //     Date: {DateTime.UtcNow:s}
              // </auto-generated>
              //----------------------------------------------------------------------------
              """;
        
        var classBuilder = new StringBuilder();
        classBuilder.AppendLine(preamble);
        ...
        classBuilder.AppendLine();
        classBuilder.AppendLine($"[GeneratedCode(\"{generatorAssemblyName.Name}\", \"{generatorAssemblyName.Version}\")]");
